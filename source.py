...
root = Tk()
root.title(" Disease Prediction Using Random Forest")
root.configure()
...
w2 = Label(root, justify=LEFT, text=" Disease Prediction Using Random Forest")
...
lr = Button(root, text="Predict", height=2, width=20,
            command=message, activebackground="purple", bd=10)
